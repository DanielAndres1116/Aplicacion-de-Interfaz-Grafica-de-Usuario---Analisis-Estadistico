...
### Imagen 1: Primera pestaña desplegable
...
### Imagen 2: segunda pestaña desplegable
...
### Imagen 3: Conteo de vuelos por aerolínea según Estado de destino representado en Treemap chart.
...
### Imagen 4: Estado FL (Florida) y representación gráfica de la cantidad de vuelos recibidos de cada Aerolínea: AA-DL-WIN, B6, etc.

![imagen](https://user-images.githubusercontent.com/43154438/135188876-c5d89d57-28fe-4d6d-9209-df94cf5bde87.png)
### Imagen 5: Porcentaje de aterrizajes desviados dada la aerolínea
...
### Imagen 6: Número de vuelos desde cada estado en Choroplet-Map
...
### Imagen 7: Cancelación de vuelos mensuales por mes según el código de cancelación en un bar-chart.
...
### Imagen 8: Promedio mensual de tiempo de vuelo por aerolínea en minutos en un Line Chart
...
### Imagen 9: Promedio mensual de tiempo de vuelo en la aerolínea 9E (9-Air).
...
### Imagen 10: Vista general de la disposición de los gráficos de la primera opción (Reporte Anual del Rendimiento de las Aerolineas).
...
### Imagen 11: Vista general de la disposición de los gráficos de la segunda opción (Reporte Anual de Retardos de Aerolíneas)
